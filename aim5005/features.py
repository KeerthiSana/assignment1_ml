...
'''
references:
https://stackoverflow.com/questions/68815598/how-to-build-a-custom-scaler-based-on-standardscaler
https://discourse.julialang.org/t/calculating-a-standardization-function-from-scratch/34117
